...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextInputLayout textInputLayoutRdb;
    ...
    private TextInputEditText textInputEditTextRdb;
    ...
    private void initViews() {
        ...
        textInputLayoutRdb = (TextInputLayout) findViewById(R.id.textInputLayoutRdb);
       ...
       textInputEditTextRdb = (TextInputEditText) findViewById(R.id.textInputEditTextRdb);
    ...
    private void postDataToSQLite() {
        ...
        if (!inputValidation.isInputEditTextFilled(textInputEditTextRdb,textInputLayoutRdb,getString(R.string.error_valid_email_password))){
            return ;
        }
        ...
        if (!databaseHelper.checkUser(textInputEditTextEmail.getText().toString().trim())) {
           ...
           /* user.setNbr_rdb(textInputEditTextRdb.getText().toString().trim());*/
